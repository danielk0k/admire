...
function Footer() {
  return (
    <VStack as="footer" spacing={8} marginTop={20}>
      <ArrowUpIcon
        boxSize={10}
        rounded="full"
        borderWidth={2}
      ...
      />
      <HStack spacing={6}>
        <Link href="https://github.com/danielk0k/admire">
        ...
        <Link href="https://twitter.com/danielk0k">
          <svg viewBox="0 0 128 128" width={40}>
            <path
      ...
      <VStack>
        <Heading size={{ base: "lg", lg: "xl" }}>Admire</Heading>
        <Text fontSize={{ base: "sm", lg: "md" }}>Click Curate Share</Text>
      </VStack>
    </VStack>
  );
}
